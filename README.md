...
**Live Application:** [Query Generator App - Azure Deployment](https://l00188491-web-app-pipeline-h0breuchbbf3hvfm.swedencentral-01.azurewebsites.net/) *(Right-click → Open in new tab)*
